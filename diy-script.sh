...
# Themes
git clone --depth=1 https://github.com/helmx/luci-theme-argon package/luci-theme-argon
git clone --depth=1 https://github.com/jerrykuku/luci-app-argon-config package/luci-app-argon-config
git clone --depth=1 https://github.com/helmx/luci-theme-design package/luci-theme-design
...
#sed -i "s/${orig_version}/R${date_version} by helmx/g" package/lean/default-settings/files/zzz-default-settings
